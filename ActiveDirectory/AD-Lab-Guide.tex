...
\definecolor{tcioeblue}{RGB}{0,71,133}
\definecolor{tcioedark}{RGB}{20,40,70}
\definecolor{tcioelight}{RGB}{230,240,250}
...
% â”€â”€ Hyperref â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
\hypersetup{
    colorlinks=true,
    linkcolor=tcioeblue,
    urlcolor=tcioeblue,
    pdfauthor={TCIOE IT Department},
    pdftitle={Active Directory Lab Setup Guide},
    pdfsubject={Windows Server AD DS with RBAC},
}

% â”€â”€ Code Listings â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
\lstdefinestyle{powershell}{
    ...
    tabsize=4,
    keywordstyle=\color{tcioeblue}\bfseries,
    commentstyle=\color{gray},
    stringstyle=\color{accentgreen},
    numbers=none,
    literate={â†’}{$\rightarrow$}1 {â†}{$\leftarrow$}1,
}
\lstset{style=powershell}

% â”€â”€ Custom Boxes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
% â”€â”€ Section Styling â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
\titleformat{\section}
    {\Large\bfseries\color{tcioeblue}}
    {Part \thesection:}{0.5em}{}
    [\vspace{-4pt}\textcolor{tcioeblue}{\rule{\textwidth}{1.5pt}}]

\titleformat{\subsection}
    {\large\bfseries\color{tcioedark}}
    {\thesubsection}{0.5em}{}

\titleformat{\subsubsection}
    {\normalsize\bfseries\color{tcioedark}}
    {\thesubsubsection}{0.5em}{}

% â”€â”€ Header / Footer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{gray}{TCIOE --- Active Directory Lab Guide}}
...
\begin{tikzpicture}[remember picture, overlay]
    % Top blue bar
    \fill[tcioeblue] (current page.north west) rectangle ([yshift=-4cm]current page.north east);
    % Accent line
    \fill[accentgreen] ([yshift=-4cm]current page.north west) rectangle ([yshift=-4.15cm]current page.north east);
    % Bottom bar
    \fill[tcioedark] (current page.south west) rectangle ([yshift=2cm]current page.south east);
\end{tikzpicture}
...
\begin{center}
    {\LARGE\bfseries\textcolor{tcioeblue}{Windows Server 2019}}\\[10pt]
    {\LARGE\textcolor{tcioedark}{Domain Controller with RBAC}}\\[8pt]
    {\large\textcolor{tcioedark}{2000 Users --- 5 Labs $\times$ 24 PCs --- Lab Management API}}\\[40pt]

    \textcolor{tcioeblue}{\rule{0.6\textwidth}{1pt}}\\[20pt]

    {\large
    \begin{tabular}{rl}
        \textbf{Domain:}       & \texttt{tcioe.edu.np} \\[4pt]
        \textbf{Environment:}  & VMware ESXi 8.0 \\[4pt]
        \textbf{Prepared by:}  & TCIOE IT Department \\[4pt]
...
\begin{itemize}
    ...
    \item Creates the forest: \texttt{tcioe.edu.np} (NetBIOS: \texttt{TCIOE})
    \item \textbf{Server reboots automatically} --- wait 2--3 minutes
\end{itemize}

\begin{warningbox}
After reboot, the login screen will show \texttt{TCIOE\textbackslash Administrator}. Use your Administrator password to login.
\end{warningbox}
...
\begin{center}
\begin{tikzpicture}[
    box/.style={draw, rounded corners=4pt, fill=tcioelight, minimum width=3cm, minimum height=0.8cm, align=center, font=\small},
    arrow/.style={->, thick, color=tcioeblue}
]
...
\begin{center}
\begin{tikzpicture}[
    lab/.style={draw, rounded corners=4pt, fill=tcioelight, minimum width=2.8cm, minimum height=1.8cm, align=center, font=\small},
    sw/.style={draw, rounded corners=2pt, fill=white, minimum width=1.8cm, minimum height=0.6cm, align=center, font=\footnotesize},
    dc/.style={draw, rounded corners=6pt, fill=tcioelight, minimum width=3.5cm, minimum height=1.5cm, align=center},
    arrow/.style={thick, color=tcioeblue}
]
    % Core switch / DC
...
\begin{enumerate}
    \item Open \textbf{Group Policy Management} $\rightarrow$ create GPO under \texttt{TCIOE Computers}
...
4 & Domain-joined & Joined to \texttt{tcioe.edu.np} domain \\
...
Enter \texttt{TCIOE\textbackslash Administrator} credentials when prompted. PC reboots and is now domain-joined.
...
\begin{cmdbox}
\begin{tabular}{ll}
\textbf{Username:} & \texttt{TCIOE\textbackslash suman.adhikari} \\
...
\begin{cmdbox}
\begin{tabular}{ll}
Username: & \texttt{TCIOE\textbackslash suman.sharma} \\
...
\begin{center}
\begin{tikzpicture}[
    server/.style={draw, rounded corners=6pt, fill=tcioelight, minimum width=4.5cm, minimum height=3.2cm, align=center},
    host/.style={draw, rounded corners=6pt, fill=white, minimum width=10cm, minimum height=5.5cm, align=center, dashed, thick, color=tcioeblue},
    ...
    % Network line
    \draw[thick, color=tcioeblue] (-5,-2.5) -- (5,-2.5);
...
\vfill
\begin{center}
\textcolor{tcioeblue}{\rule{0.4\textwidth}{1pt}}\\[10pt]
{\small\textcolor{gray}{Prepared by TCIOE IT Department --- June 2026}}\\
